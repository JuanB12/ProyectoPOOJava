 ...
 * @author Lenovo
 */
public class interfazMonitores extends javax.swing.JFrame {

    /**
     * Creates new form interfazMonitores
     */
    public interfazMonitores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabelSALIR2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, 50, 40));
        ...
        jPanel1.add(jButtonSALIR, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 280, 180, 40));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Marca", "Precio", "Cantidad", "Resolución", "Tamaño '' "
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 600));
        ...
        jPanel1.add(jLabelMENU, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 230, 50, 40));
        ...
        jPanel1.add(jButtonMENU, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 230, 180, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfazMonitores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfazMonitores().setVisible(true);
            }
        });
    }
