...
import Inventario.Memorias;

/**
 *
 * @author JuanB
 */
public class interfazMemorias extends javax.swing.JFrame {

    /**
     * Creates new form interfazMemorias
     */
    public interfazMemorias() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 600));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 817, 600));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfazMemorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfazMemorias().setVisible(true);
            }
        });
    }
